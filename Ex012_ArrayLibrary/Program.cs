...
int pos = IndexOf(array, 4);          //задаём переменную pos куда поместим результат работы нашего метода IndexOf
                                      //в аргументах метода указываем имя нашего массива array и значение 4 индекс которого ищем
Console.WriteLine(pos);               //выводим в консоль значение переменной pos, номер индекса элемента нашего массива